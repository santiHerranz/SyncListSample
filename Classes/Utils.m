...
+ (bool) hasChanges:(NSManagedObjectContext*) context
{
	...
	if ([Utils clientHasSynced:context])
	{
		...
		NSFetchRequest *fetchLists = [[NSFetchRequest alloc] init];
		...
		NSFetchRequest *fetchTagItemMapping = [[NSFetchRequest alloc] init];
...
{
	// Cleanup tags
	NSFetchRequest *fetchTag = [[NSFetchRequest alloc] init];
	...
	// Cleanup Status
	NSFetchRequest *fetchStatus = [[NSFetchRequest alloc] init];
	...
	// Cleanup Priority
	NSFetchRequest *fetchPriority = [[NSFetchRequest alloc] init];
	...
	// Cleanup List
	NSFetchRequest *fetchList = [[NSFetchRequest alloc] init];
	...
	// Cleanup Anchor
	NSFetchRequest *fetchAnchor = [[NSFetchRequest alloc] init];
